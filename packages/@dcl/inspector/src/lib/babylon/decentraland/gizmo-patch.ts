...
import { Epsilon, Quaternion, Logger, TmpVectors, PointerDragBehavior, Gizmo, Matrix, Observable, StandardMaterial, Mesh, CreatePlane, ShaderMaterial, Effect } from "@babylonjs/core";
...
export class PatchedPlaneRotationGizmo extends PlaneRotationGizmo {
    ...
    constructor(planeNormal: any, color = Color3.Gray(), gizmoLayer: any, tessellation = 32, parent: any = null, 
    ...
    useEulerRotation = false, thickness = 1) {
        ...
        this.dragBehavior.onDragObservable.add((event) => {
            if (this.attachedNode) {
                ...
                if (this.updateGizmoRotationToMatchAttachedMesh) {
                    ...
                    */
                    amountToRotate.toRotationMatrix(TmpVectors.Matrix[0]);
                    let translation = this.attachedNode.getWorldMatrix().getTranslation()
        ...
        (_a = this._parent) === null || _a === void 0 ? void 0 : (_a as RotationGizmo).addToAxisCache(this._gizmoMesh, cache);
        this._pointerObserver = gizmoLayer.utilityLayerScene.onPointerObservable.add((pointerInfo: PointerInfo) => {
            ...
            this.dragBehavior.maxDragAngle = PlaneRotationGizmo.MaxDragAngle;
            this._isHovered = !!(cache.colliderMeshes.indexOf(((_a = pointerInfo === null || pointerInfo === void 0 ? void 0 : pointerInfo.pickInfo) === null || _a === void 0 ? void 0 : _a.pickedMesh) as Mesh) != -1);
            if (!this._parent) {
...
export class PatchedRotationGizmo extends RotationGizmo {
    ...
    constructor(gizmoLayer: any, tessellation = 32, useEulerRotation = false, thickness = 1, gizmoManager: any, options: any) {
        super(gizmoLayer);
        ...
        this.xGizmo = new PatchedPlaneRotationGizmo(new Vector3(1, 0, 0), xColor, gizmoLayer, tessellation, this, useEulerRotation, thickness);
        this.yGizmo = new PatchedPlaneRotationGizmo(new Vector3(0, 1, 0), yColor, gizmoLayer, tessellation, this, useEulerRotation, thickness);
        this.zGizmo = new PatchedPlaneRotationGizmo(new Vector3(0, 0, 1), zColor, gizmoLayer, tessellation, this, useEulerRotation, thickness);
    ...
    set rotationGizmoEnabled(value: boolean) {
        if (value) {
            if (!this.gizmos.rotationGizmo) {
                this.gizmos.rotationGizmo = new PatchedRotationGizmo(this._defaultUtilityLayer, 32, false, this._thickness, this, undefined);
            }
