  ...
  public attachControl(noPreventDefault?: boolean): void {
        ...
        if (!this['_pointerInput']) {
            this['_pointerInput'] = (p: any) => {
                ...
                } else if (p.type === BABYLON.PointerEventTypes.POINTERMOVE && (this['_activePointerId'] === evt.pointerId || !isTouch)) {
                    if (engine.isPointerLock && this['_onMouseMove']) {
                        this['_onMouseMove'](p.event);
        ...
        this['_observer'] = this.camera
            .getScene()
            ._inputManager._addCameraPointerObserver(this['_pointerInput'], BABYLON.PointerEventTypes.POINTERDOWN | BABYLON.PointerEventTypes.POINTERUP | BABYLON.PointerEventTypes.POINTERMOVE);
