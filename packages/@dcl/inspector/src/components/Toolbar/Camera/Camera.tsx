...
export const Camera = withSdk(({ sdk }) => {
  ...
  const [invertXAxis, setInvertXAxis] = useState(sdk.preferences.data.cameraInvertXAxis)
  const [invertYAxis, setInvertYAxis] = useState(sdk.preferences.data.cameraInvertYAxis)
