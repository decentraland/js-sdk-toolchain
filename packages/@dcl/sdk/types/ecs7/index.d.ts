...
declare namespace Components {
    ...
    /** @public */
    const MeshRenderer: {
        create(entity: Entity, val?: WrappedMeshRenderer | undefined): PBMeshRenderer;
        createOrReplace(entity: Entity, val?: WrappedMeshRenderer | undefined): PBMeshRenderer;
        _id: number;
        default(): DeepReadonlyObject<PBMeshRenderer>;
        has(entity: Entity): boolean;
        get(entity: Entity): DeepReadonlyObject<PBMeshRenderer>;
        getOrNull(entity: Entity): DeepReadonlyObject<PBMeshRenderer> | null;
        deleteFrom(entity: Entity): PBMeshRenderer | null;
        getMutable(entity: Entity): PBMeshRenderer;
        getMutableOrNull(entity: Entity): PBMeshRenderer | null;
        ...
        iterator(): Iterable<[Entity, PBMeshRenderer]>;
...
declare interface WrappedMeshRenderer {
    box?: undefined | {
        uvs?: number[];
    };
    sphere?: PBMeshRenderer_SphereMesh | undefined;
