...
describe('Virtual scale factor with array UI renderers', () => {
  ...
  it('should apply scale factor when returning an array of direct function calls', async () => {
    ...
    uiRenderer.setUiRenderer(() => [Panel1(), Panel2()], { virtualWidth: 1920, virtualHeight: 1080 })
  ...
  it('should apply scale factor when returning an array of JSX components', async () => {
    ...
    uiRenderer.setUiRenderer(() => [<Panel1 key="p1" />, <Panel2 key="p2" />], {
      virtualWidth: 1920,
      virtualHeight: 1080
    })
...
describe('Virtual scale factor with mixed % and pixel values', () => {
  ...
  it('should scale pixel children inside a %-sized parent', async () => {
    ...
    // scale = Math.min(3840/1920, 2160/1080) = 2
    uiRenderer.setUiRenderer(() => <PercentParentWithPixelChildren />, { virtualWidth: 1920, virtualHeight: 1080 })
  ...
  it('should scale pixel parent but not %-sized children', async () => {
    ...
    uiRenderer.setUiRenderer(() => <PixelParentWithPercentChildren />, { virtualWidth: 1920, virtualHeight: 1080 })
  ...
  it('should handle deeply nested mixed % and pixel values', async () => {
    ...
    uiRenderer.setUiRenderer(() => <DeeplyNestedMixed />, { virtualWidth: 1920, virtualHeight: 1080 })
  ...
  it('should scale pixel children inside %-sized parent returned as array', async () => {
    ...
    uiRenderer.setUiRenderer(() => [PercentParentWithPixelChildren(), PixelParentWithPercentChildren()], {
      virtualWidth: 1920,
      virtualHeight: 1080
    })
  ...
  it('should use scale factor 1 when UiCanvasInformation is not yet available', async () => {
    ...
    uiRenderer.setUiRenderer(() => <UiEntity uiTransform={{ width: 300, height: 200 }} />, {
      virtualWidth: 1920,
      virtualHeight: 1080
    })
