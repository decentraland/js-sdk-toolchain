...
describe('Network messages', () => {
  ...
  it('should serialize put component network message', () => {
    ...
    buffer.resetBuffer()
    buffer.writeBuffer(message, false)
    expect(() => DeleteComponentNetwork.read(buffer)).toThrow()
    buffer.resetBuffer()
    buffer.writeBuffer(message, false)
    expect(() => DeleteEntityNetwork.read(buffer)).toThrow()
  })
  ...
  it('should serialize delete component network message', () => {
    ...
    buffer.resetBuffer()
    buffer.writeBuffer(message, false)
    expect(() => PutNetworkComponentOperation.read(buffer)).toThrow()
    buffer.resetBuffer()
    buffer.writeBuffer(message, false)
    expect(() => DeleteEntityNetwork.read(buffer)).toThrow()
    buffer.resetBuffer()
