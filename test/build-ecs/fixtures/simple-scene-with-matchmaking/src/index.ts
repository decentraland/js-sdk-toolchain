...
import { connectToMatchMackingServer } from '@dcl/sdk/matchmaking'
...
export async function main() {
  ...
  const matchMakingServerUrl = realm.realmInfo?.isPreview
    ? 'ws://127.0.0.1:3001/ws/hugoarregui.dcl.eth'
    : 'wss://matchmaking-server.decentraland.zone/ws/hugoarregui.dcl.eth'
  await connectToMatchMackingServer(matchMakingServerUrl)
