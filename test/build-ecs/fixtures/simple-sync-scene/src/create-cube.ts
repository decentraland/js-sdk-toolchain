...
export function createSyncCube(entityFactory: NetworkManager, x: number, y: number, z: number): Entity {
...
export function createLocalCube(x: number, y: number, z: number): Entity {
